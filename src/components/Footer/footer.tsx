    ...
    <footer className="footer-section">
      ...
      <div className="footer-main">
        <div className="footer-container">
          ...
          {/* Role Categories */}
          <div className="footer-column">
            <h3 className="footer-column-title">Roles</h3>
            <ul className="footer-links">
              <li><Link to="/development-innovation">Development & Innovation</Link></li>
              <li><Link to="/infrastructure-operations">Infrastructure & Operations</Link></li>
              <li><Link to="/digital-marketing-growth">Digital Marketing & Growth</Link></li>
